          ...
          <Comment>
            ...
            {star_num.map((item, i) => {
              return (
                <Star
                  key={i}
                  style={{ color: avg < i + 1 ? "#D9D9D6" : "#F2A900" }}
                >
                  ★
                </Star>
              );
          ...
          <CommentTable>
            <TableInfo>
              ...
              <ReveiwButtonWrap>
                <ReviewButton
                  onClick={() => {
                    Navigate(`/reviewwrite/${list.id}/${productId}`);
                  }}
                >
                  <img
                    src="//recipe1.ezmember.co.kr/img/mobile/icon_write2.png"
                    alt=""
            ...
            <InfoName>
              ...
              <>
                <button
                  className="btn"
                  onClick={() => {
                    Navigate(`/reviewedit/${list.id}/${productId}`);
                  }}
                >
                  수정
                </button>
                <button
                  className="btn"
                  onClick={() => {
                    dispatch(deleteReviewAX(productId));
                  }}
                >
                  삭제
                </button>
            ...
            {star_num.map((i) => {
              return (
                <LitteStar
                  key={i}
                  style={{
                    color: data[idx].star < i + 1 ? "#D9D9D6" : "#F2A900",
                  }}
                >
                  ★
                </LitteStar>
